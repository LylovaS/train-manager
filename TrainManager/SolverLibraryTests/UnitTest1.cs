...
namespace SolverLibraryTests
{
    ...
    public class StationGraphTest
    {
        ...
        public void SimpleStationTest()
        {
            ...
            Edge edge01 = new Edge(0, 1, vertex, vertex1, TrainType.NONE);
        ...
        public void CorrectStationTest()
        {
            ...
            Edge edge01 = new Edge(0, 1, vertex, vertex1, TrainType.NONE);
            Edge edge12 = new Edge(1, 1, vertex1, vertex2, TrainType.NONE);
            Edge edge25 = new Edge(2, 1, vertex2, vertex5, TrainType.NONE);
            Edge edge13 = new Edge(3, 1, vertex1, vertex3, TrainType.NONE);
            Edge edge34 = new Edge(4, 1, vertex3, vertex4, TrainType.NONE);
            vertex.SetEdge(edge01);
        ...
        public void IncorrectStationTest()
        {
            ...
            Edge edge12 = new Edge(1, 1, vertex1, vertex2, TrainType.NONE);
            Edge edge25 = new Edge(2, 1, vertex2, vertex5, TrainType.NONE);
            Edge edge14 = new Edge(3, 1, vertex1, vertex4, TrainType.NONE);
            vertex.SetEdge(edge01);
